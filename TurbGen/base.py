"""
This is the 'base' module for the TurbGen program.
...
try:
    ...
    print """
    ***Warning***: 'tslib' did not load correctly.  TurbGen
...
class gridObj(tsBaseObj):
    ...
    def __repr__(self,):
        return ('<TurbGen Grid:%5.1fm high x %0.1fm wide grid  (%d x %d points)'
    ...
    def rotor_diam(self,):
        ...
        This is how TurbGen quantifies rotor diameter.
        """
...
class modelBase(tsBaseObj):
    ...
    """
    An abstract base class for all TurbGen models.
    """
    ...
    def parameters(self,):
        """
        This property stores information about the TurbGen model
