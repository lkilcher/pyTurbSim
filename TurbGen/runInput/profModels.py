...
def _h2l(tsinput):
    ...
    Returns
    -------
    profModel : :class:`TurbGen.profModels.log.H2O`
...
def _log(tsinput):
    ...
    Returns
    -------
    profModel : :class:`TurbGen.profModels.log.nwtc`
...
def _pl(tsinput):
    ...
    Returns
    -------
    profModel : :class:`TurbGen.profModels.power.nwtc`
...
def _iec(tsinput):
    ...
    Returns
    -------
    profModel : :class:`TurbGen.profModels.iec.main`
