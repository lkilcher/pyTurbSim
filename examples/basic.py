"""
This script describes example usage of PyTurbSim
"""
...
#####
# For more details on spectral 'models', see the docstrings for each
# model type (profile, spectra, coherence, Reynold's stress), and also
# take a look at the 'models_and_stats_example.py' file.
