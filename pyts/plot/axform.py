...
class _base(object):
    ...
    def finalize(self,axes):
        ...
        if hasattr(self,'xtick_n'):
            for ax in axes:
                ax.xaxis.set_major_locator(mpl.ticker.MaxNLocator(self.xtick_n))
...
class spec(_base):
    ...
    def _calc_tsdata(self,tsdata,comp,igrid=None):
        ...
        return psd.psd(tsdata.uturb[comp][igrid],1./tsdata.dt,nfft)
...
class cohere(_base):
    ...
    def _calc_tsdata(self,tsdata,comp,igrid0=None,igrid1=None):
        ...
        return psd.coh(tsdata.uturb[comp][igrid0],tsdata.uturb[comp][igrid1],1./tsdata.dt,nfft)
