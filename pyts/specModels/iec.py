...
class iecbase(specModelBase):
    ...
    Parameters
    ----------
    IECwindtype : str {'NTM'=normal, 'xETM'=extreme turbulence,'xEWM1'=extreme 1-year wind, 'xEWM50'=extreme 50-year wind, where x=wind turbine class 1, 2, or 3}
    IECstandard : int {1}
    ...
    def IEC_Sigma(self,uhub):
        r"""
        Calculate the default value of the standard deviation of u-component wind speed, :math:`\sigma` or :math:`\sigma_u`.

        Notes
        -----

        For input :class:`IECturbc <iecbase>` a numeric value, it simply specifies the turbulence intensity. That is,
